...
@section('content')
    <p>{{ __('Met een account kun je jezelf aanmelden voor activiteiten en je inschrijven als lid. Je hoeft geen lid te zijn van onze vereniging om je aan te kunnen melden voor activiteiten. Heb je al een account? Klik dan')}} <a href="{{ route('login') }}">{{ __('hier') }}</a> {{ __('om in te loggen.') }}</p>
        ...
        <div class="col-xs-12">
            <form method="post" action="{{ route('register') }}" class="form-horizontal">
                ...
                <div class="form-group {{ $errors->has('first_name') ? 'has-error' : ''}}">
                    <label for="first_name" class="control-label col-sm-4">{{ __('Voornaam') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('name_prefix') ? 'has-error' : ''}}">
                    <label for="name_prefix" class="control-label col-sm-4">{{ __('Tussenvoegsel') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
                    <label for="last_name" class="control-label col-sm-4">{{ __('Achternaam') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : ''}}">
                    <label for="phone_number" class="control-label col-sm-4">{{ __('Telefoonnummer') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
                    <label for="address" class="control-label col-sm-4">{{ __('Adres') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('zip_code') ? 'has-error' : ''}}">
                    <label for="zip_code" class="control-label col-sm-4">{{ __('Postcode') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('city') ? 'has-error' : ''}}">
                    <label for="city" class="control-label col-sm-4">{{ __('Stad') }} *</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : ''}}">
                    <label for="password_confirmation" class="control-label col-sm-4">{{ __('Wachtwoord herhalen') }} *</label>
                    <div class="col-sm-8">
