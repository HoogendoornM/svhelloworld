...
Je moet hiervoor wel student zijn aan de opleiding HBO-ICT van de HZ University of Applied Sciences.') }}
    ...
    <p>
        {{ __("Als je nieuwe ideeën hebt voor dit portaal mag je deze indienen op") }} <a href="https://github.com/sv-helloworld/mijn-sv-helloworld" target="_blank">{{ __("onze GitHub-pagina") }}</a>.
    </p>
